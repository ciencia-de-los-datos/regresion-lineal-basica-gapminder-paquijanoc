...
def pregunta_02():
    ...
    # Lea el archivo `gm_2008_region.csv` y asignelo al DataFrame `df`
    df = df = pd.read_csv(
    "https://raw.githubusercontent.com/ciencia-de-los-datos/regresion-lineal-basica-gapminder-paquijanoc/main/gm_2008_region.csv",
    sep=",",  # separador de campos
    thousands=None,  # separador de miles para números
    )
...
def pregunta_03():
    ...
    print(r2_score(y_life, reg.predict(X_fertility)).round(4))
